# train_multimodal_adamw.py  ── M_CBLA_BLR with AdamW
import torch
...
from multimodal import M_CBLA_BLR
...
def train(seed=42):
    ...
    print(f"  Epochs={EPOCHS}  Batch={BATCH_SIZE}  LR={LR}  WD={WEIGHT_DECAY}  AdamW")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if ua > best_ua:
            ...
            torch.save(model.state_dict(), f'best_m_cbla_blr_adamw_seed{seed}.pt')
            marker = '  ← best'
...
if __name__ == '__main__':
    ...
    print(f"\n{'='*60}")
    print(f"  [{MODEL_NAME}+AdamW]  3-run average")
